<div class="<?php echo e(str_replace('_','-',$bg_gradient ?? '')); ?> bg-img-hero space-3 space-top-lg-4 space-bottom-lg-3" <?php if(!empty($bg_image)): ?> style="background-image: url(<?php echo e(get_file_url($bg_image,'full')); ?>);" <?php endif; ?>>
    <div class="text-center mt-xl-2">
        ...
        <!-- Fancybox -->
        <a class="travel-fancybox d-inline-block u-media-player" href="javascript:;" data-src="<?php echo e(handleVideoUrl($youtube)); ?>" data-speed="700" data-animate-in="zoomIn" data-animate-out="zoomOut" data-caption="TraceyAsh - Responsive Website Template">
...
<?php /**PATH /home/m5lil/Sites/mytravel/themes/Mytravel/Template/Views/frontend/blocks/video-player.blade.php ENDPATH**/ ?>