...
<head>
    <meta charset="UTF-8"/>
    <title>Tracey Ash - Ultimate Booking System</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://www.facebook.com/traceyash/" target="_blank">Support</a>
                            <a target="_blank" class="dropdown-item" href="http://docs.traceyash.com">Documentation</a>
                    ...
                    <ul class="menu">
                        ...
                        <li><a target="_blank" href="https://www.facebook.com/traceyash/">Support</a></li>
                        <li><a target="_blank" href="http://docs.traceyash.com">Documentation</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Tracey Ash</span> is super<br />fast and easy <img src="<?php echo e(url('landing/img/hand.svg')); ?>" /></h3>
        <a target="_blank"  href="<?php echo e(config('landing.item_url')); ?>" class="btn-buynow">BUY NOW</a>
        <div class="social">
            <span>FOLLOW US</span>
            <ul>
                <li><a target="_blank" href="https://www.facebook.com/traceyash/"><svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li><a href="mailto:traceyash.com@gmail.com"><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php /**PATH /home/m5lil/Sites/mytravel/resources/views/landing/index.blade.php ENDPATH**/ ?>