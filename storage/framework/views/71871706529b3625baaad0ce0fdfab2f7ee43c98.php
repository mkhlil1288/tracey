<?php if(!empty($seo_meta)): ?>
    ...
    <?php
        ...
        if(!empty($page_title) and empty($seo_meta['is_homepage'])){
            $page_title .= " - ".setting_item_with_lang('site_title' ,false,'Tracey Ash');
        }
        if(empty($page_title)){
            $page_title = setting_item_with_lang('site_title' ,false,'Tracey Ash');
        }
...
<?php endif; ?>
<?php /**PATH /home/m5lil/Sites/mytravel/themes/Mytravel/Layout/parts/seo-meta.blade.php ENDPATH**/ ?>