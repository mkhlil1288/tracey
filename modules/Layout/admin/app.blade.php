...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Tracey Ash'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Tracey Ash by')}} <a href="{{__('https://www.traceyash.com')}}" target="_blank">{{__('TraceyAsh Team')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://www.traceyash.com')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://m.me/traceyash')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
