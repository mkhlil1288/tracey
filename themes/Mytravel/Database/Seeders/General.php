...
<a href="mailto:contact@mytravel.com">contact@mytravel.com</a>',
    ...
    <div class="mb-5 mr-md-7 mr-lg-0">
        <h4 class="h6 mb-4 font-weight-bold">Need Tracey Ash Help?</h4>
        ...
        <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item mr-2">
                ...
                [
                    ...
                    'val'   => '© 2021 TraceyAsh. All rights reserved',
                    'group' => "general",
                ],
                [
...
<p>This document was last updated on October 6, 2020</p>';
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2021 Tracey Ash. All rights reserved</p>',
                    'group' => "general",
                ],
                [
