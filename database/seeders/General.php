...
<a href="mailto:contact@traceyash.com">contact@traceyash.com</a>',
                    'group' => "general",
                ],
                [
                    'name'  => 'footer_text_left',
                    'val'   => 'Copyright © 2019 by Tracey Ash',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>Tracey Ash</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
...
<h2>Contacting us</h2>
<p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may do so via the <a target="_blank" rel="nofollow" href="http://dev.traceyash.com/contact">contact form</a></p>
<p>This document was last updated on October 6, 2020</p>';
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">Tracey Ash</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2019 Tracey Ash. All rights reserved</p>',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with Tracey Ash! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Tracey Ash</p>',
                    'group' => "user",
                ],
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>Tracey Ash Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
                                <p>www.traceyash.com</p>",
                    'group' => "booking",
                ],
            ]);
    }
